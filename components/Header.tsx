...
export default function Header() {
	...
	return (
		<header>
			<div className="absolute top-0 left-0 w-full h-96 bg-gradient-to-br from-pink-400 to-blue-600 rounded-md filter blur-3xl opacity-50 -z-10" />
			...
			<div className="flex items-center justify-center px-5 py-2 md:py-5">
				<p className="flex items-center text-sm font-light p-5 pr-5 shadow-xl rounded-xl w-fit bg-white italic max-w-3xl text-[#0055d1]">
					...
					/>
					{suggestion && !loading ? suggestion : "GPT resumo do dia..."}
				</p>
			</div>
		</header>
	);
